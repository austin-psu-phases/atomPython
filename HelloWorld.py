...
for i in range(len(diff1)):
    anglesz.append(asin(diff1[i,1]/sqrt(pow(diff1[i,0],2)+pow(diff1[i,1],2))))

for i in range(len(diff1)):
    anglesy.append(asin(diff1[i,2]/sqrt(pow(diff1[i,0],2)+pow(diff1[i,1],2)+pow(diff1[i,2],2))))
...
k1=np.dot(rotate(1.1,diff1[1]),unormvecs[1])
